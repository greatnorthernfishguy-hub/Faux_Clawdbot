...
ChromaDB (fast local queries) ←→ HF Dataset (durable cloud storage)
                              ...
                              Contains: conversations.json, metadata.json
...
class HFDatasetPersistence:
    ...
    - /data mount: Requires paid Space tier
    ...
    def __init__(self, repo_id: str = None):
        ...
        Args:
            repo_id: HF Dataset repo (e.g., "username/clawdbot-memory")
                     If None, uses MEMORY_REPO env var or creates default
        """
        ...
        self.SAVE_DEBOUNCE_SECONDS = 30  # Min time between cloud saves
    ...
    def _ensure_repo_exists(self):
        ...
        try:
            ...
            try:
                ...
                print(f"⚠️ Could not create memory repo: {e}")
    ...
    def save_conversations(self, conversations_data: List[Dict], force: bool = False):
        ...
        with self._save_lock:
            try:
                ...
                self._pending_save = False
                print(f"☁️ Saved {len(conversations_data)} conversations to {self.repo_id}")
                return True
    ...
    def load_conversations(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"☁️ Loaded {len(data)} conversations from {self.repo_id}")
            return data
            
        except Exception as e:
            # File might not exist yet (first run)
            if "404" in str(e) or "not found" in str(e).lower():
                print(f"📝 No existing conversations found in {self.repo_id}")
            else:
...
class RecursiveContextManager:
    ...
    def __init__(self, repo_path: str):
        ...
        # NOTE: This path still gets wiped, but we restore from HF Dataset
        ...
        self.BACKUP_EVERY_N_SAVES = 5  # Backup to cloud every N conversation turns
    ...
    def _restore_from_cloud(self):
        ...
        # Re-add each conversation to ChromaDB
        for conv in cloud_data:
            try:
                ...
                print(f"⚠️ Skipping conversation {conv.get('id')}: {e}")
        
        print(f"✅ Restored {self.conversations.count()} conversations")
    ...
    def get_stats(self) -> Dict:
        ...
        return {
            ...
            "cloud_backup_enabled": bool(self.persistence.repo_id)
        }

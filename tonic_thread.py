...
# Why: Codemine worker needs the heuristic Tonic for continuous substrate
#   awareness between spec executions. No transformer weights on HF →
#   TonicEngine runs in heuristic mode automatically.
# -------------------
"""
